...
fprintf("cost returned from nnCostFunction:\n");
disp(cost);
fprintf("grad returned from nnCostFunction:\n");
disp(grad)
fprintf("nn_params returned from nnCostFunction:size(%d %d)\n", size(nn_params, 1), size(nn_params, 2));
disp(nn_params)
